...
SELECT pg_catalog.setval('tb_alunos_id_seq', 4, true);
...
SELECT pg_catalog.setval('tb_cursos_id_seq', 2, true);
...
SELECT pg_catalog.setval('tb_periodos_id_seq', 1, true);
...
SELECT pg_catalog.setval('tb_turmas_id_seq', 1, false);
